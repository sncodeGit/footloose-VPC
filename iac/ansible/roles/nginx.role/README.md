...
`letsencrypt: yes` - create symilink to /etc/letsenrypt/live... certs and private keys (by server name)

`htpasswd: yes` - create htpasswd files for this host by server name
